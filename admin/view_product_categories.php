                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $p_cat_desc = $row_p_cats['product_category_description'];
                            ...
                            <tr>
                                ...
                                <td> 
                                    <a href="index.php?delete_product_category=<?php echo $p_cat_id; ?>">
                                        <i class="fa fa-trash-o"></i> Delete
                                    </a>
                                </td>
                                <td>
                                    <a href="index.php?edit_product_category=<?php echo $p_cat_id; ?>">
